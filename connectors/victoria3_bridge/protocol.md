...
prefix may precede the marker; consumers start parsing at `[EDENAGENT]|`.

```text
[EDENAGENT]|1|HELLO|bridge_version=0.1.0|mode=observe
[EDENAGENT]|1|SNAPSHOT|date=1842.03.15|country_id=CHI|country_name=Great Qing|...
...
`run edenagent_<uuid>` into the Debug console. Success is reported only after the
