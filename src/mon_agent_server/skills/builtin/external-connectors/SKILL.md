...
metadata:
  monagent:
    display_name: 外部连接器
    version: 1.0.0
    tools: [web, list_connectors, register_connector, set_connector_state, claim_connector_events, finish_connector_events, execute_connector_action, query_openttd]
