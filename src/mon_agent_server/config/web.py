...
_SEARCH_ENV_KEYS = {
    ...
    "EXA_MCP_URL": "MON_AGENT_EXA_MCP_URL",
    "PARALLEL_MCP_URL": "MON_AGENT_PARALLEL_MCP_URL",
    "MCP_COOLDOWN_SECONDS": "MON_AGENT_SEARCH_MCP_COOLDOWN_SECONDS",
    ...
    "DUCKDUCKGO_PROXY": "MON_AGENT_DUCKDUCKGO_PROXY",
    "DUCKDUCKGO_COOLDOWN_SECONDS": "MON_AGENT_DUCKDUCKGO_COOLDOWN_SECONDS",
