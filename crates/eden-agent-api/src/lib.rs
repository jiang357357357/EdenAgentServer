//! Typed client protocol for the Eden Agent local server.
...
pub const WEBSOCKET_PROTOCOL: &str = "eden-agent-rpc-v2";
pub const TOKEN_PROTOCOL_PREFIX: &str = "eden-agent-token.";
